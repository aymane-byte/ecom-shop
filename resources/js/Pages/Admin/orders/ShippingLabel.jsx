...
export default function ShippingLabel({ order }) {
    ...
    const address = safeText(order.customer_address, 'ADRESSE NON RENSEIGNÉE');
    ...
    return (
        <div className="min-h-screen bg-slate-100 px-4 py-6 print:bg-white print:p-0">
            <Head title={`Étiquette d'expédition - Commande ${code}`} />
            ...
            <main className="mx-auto flex h-[150mm] w-[100mm] max-w-full flex-col bg-white text-black shadow-xl ring-1 ring-slate-300 print:m-0 print:shadow-none print:ring-0 [transform-origin:top_center] scale-[0.5] sm:scale-[0.6] md:scale-[0.8] lg:scale-[0.9] xl:scale-1">
                <header className="grid grid-cols-[1fr_34mm] border-b-2 border-black">
                    <div className="p-3">
                        <div className="flex items-start justify-between gap-3">
                            <div>
                                ...
                                <p className="mt-1 text-[8px] font-bold uppercase tracking-[0.18em]">Expédition E-commerce</p>
                            </div>
                        ...
                        <div className="mt-3 grid grid-cols-2 gap-2 text-[9px] font-bold uppercase">
                            <div className="rounded border border-black p-1.5">
                                <p className="text-[7px] font-black text-slate-600">Expéditeur</p>
                                <p>Monocle Store</p>
                            </div>
                            <div className="rounded border border-black p-1.5">
                                <p className="text-[7px] font-black text-slate-600">Date d'expédition</p>
                    ...
                    <div className="border-l-2 border-black p-2 text-center">
                        <p className="text-[7px] font-black uppercase tracking-wide">Zone de tri</p>
                ...
                <section className="border-b-2 border-black p-3">
                    <div className="flex items-center justify-between">
                        <p className="text-[8px] font-black uppercase tracking-[0.2em]">Informations Destinataire</p>
                        <p className="rounded bg-black px-2 py-1 text-[8px] font-black uppercase text-white">À livrer</p>
                    </div>
                    <h1 className="mt-2 text-[20px] font-black uppercase leading-tight">
                        {safeText(order.customer_name, 'NOM DU CLIENT')}
                    </h1>
                    ...
                    <div className="mt-3 rounded border-2 border-black px-2 py-1.5">
                        <p className="text-[8px] font-black uppercase tracking-wide">Téléphone du destinataire</p>
                ...
                <section className="grid flex-1 grid-cols-[1fr_31mm] border-b-2 border-black">
                    <div className="p-3">
                        <p className="text-[8px] font-black uppercase tracking-[0.2em]">Contenu du colis</p>
                        ...
                        {(order.items || []).length > 6 && (
                            <p className="mt-2 text-[9px] font-black">+{order.items.length - 6} article(s) supplémentaire(s)</p>
                        )}
                    </div>

                    <div className="border-l-2 border-black p-2 text-center">
                        <p className="text-[7px] font-black uppercase tracking-wide">Nb. Articles</p>
                        <p className="mt-1 text-[24px] font-black leading-none">{order.items_count}</p>
                        <div className="mt-3 border-t border-black pt-2">
                            <p className="text-[7px] font-black uppercase tracking-wide">N° Commande</p>
                ...
                <footer className="grid grid-cols-[1fr_38mm]">
                    <div className="p-3">
                        <p className="text-[8px] font-black uppercase tracking-[0.2em]">Instructions de livraison</p>
                        <p className="mt-1 text-[10px] font-bold leading-tight">
                            Vérifier le numéro de téléphone avant toute tentative de livraison. Ne pas plier le colis. À remettre uniquement au destinataire ou à son représentant autorisé.
                        </p>
                    </div>
                    <div className="border-l-2 border-black p-2 text-center">
                        <p className="text-[8px] font-black uppercase tracking-wide">Montant à encaisser (COD)</p>
