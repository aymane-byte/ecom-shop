...
function Label({ order }) {
    ...
    const city = safeText(order.customer_city, 'VILLE');
    const address = safeText(order.customer_address, 'ADRESSE');
    const phone = safeText(order.customer_phone, 'TEL');
        ...
        <div className="h-[150mm] w-[100mm] bg-white text-black p-2 flex flex-col border-2 border-black">
            ...
            <div className="flex justify-between items-start border-b-2 border-black pb-1">
                <div>
                    ...
                    <p className="text-[4px] font-bold uppercase">E-commerce</p>
                </div>
            ...
            <div className="flex justify-center py-1 border-b-2 border-black">
                <div className="border-2 border-black px-3 py-1">
                    <p className="text-[4px] font-black uppercase text-center">Zone</p>
            ...
            <div className="border-b-2 border-black py-1">
                <p className="text-[4px] font-black uppercase bg-black text-white inline-block px-1">Destinataire</p>
                <p className="text-[11px] font-black uppercase mt-0.5">{safeText(order.customer_name, 'CLIENT')}</p>
                <p className="text-[8px] font-bold uppercase">{address}</p>
                <p className="text-[9px] font-black uppercase">{city}</p>
                <p className="text-[8px] font-black mt-0.5">Tel: {phone}</p>
            </div>
            ...
            <div className="flex-1 border-b-2 border-black py-1 overflow-hidden">
                <p className="text-[4px] font-black uppercase">Contenu ({order.items_count} pcs)</p>
                ...
                {(order.items || []).length > 6 && (
                    <p className="text-[5px] font-black">+{order.items.length - 6} art.</p>
                )}
            </div>
            ...
            <div className="flex justify-between items-center py-1">
                <div className="text-[4px] font-bold uppercase">
                    ...
                    <p>Verifier tel avant livraison</p>
                </div>
                <div className="text-right">
                    <p className="text-[4px] font-black uppercase">A Payer</p>
