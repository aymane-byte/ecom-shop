                    ...
                    <div className="flex items-center justify-between max-w-7xl mx-auto">
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <div className="hidden md:flex items-center gap-6 text-[11px] font-semibold uppercase tracking-[0.15em]">
                                ...
                                <Link href="/about-us" className="text-[#C2A65A] hover:text-[#2D7A69] transition">
                                    {t('navbar.about_us')}
                                </Link>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="mt-6 flex flex-col gap-4">
                                    ...
                                    <Link
                                        href="/about-us"
                                        onClick={() => setMobileMenuOpen(false)}
                                        className="text-[#C2A65A] transition text-xs font-bold uppercase tracking-widest py-2 border-b border-white/5 flex items-center justify-between"
                                    >
